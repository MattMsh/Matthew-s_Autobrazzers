    ...
    $("#year-slider").slider({
        ...
        slide: function(event, ui) {
            ui.handle.innerHTML =
                '<span data-value="' +
                ui.value +
                '"  class="slider-range-value">' +
                ui.value +
                "</span>";
        },
        create: function(event, ui) {
            var ui_sl_handles = $(this).find(".ui-slider-handle");
            ui_sl_handles[0].innerHTML =
                '<span class="slider-range-value min-val">2005</span>';
            ui_sl_handles[1].innerHTML =
                '<span class="slider-range-value max-val">2016</span>';
        }
    });
    $("#amount").val(
        "$" +
